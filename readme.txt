...
geographic north pole.
    ...
    Using this assumption,  the spherical law of cosines
can be used on the spherical triangle formed between
each of these three points,  allowing for the arc length
between each of the two specified points to be found.

    As per WGS-84 standards,  the earth is in fact an
ellipsoid,  however with the great circle approach,
the standard radius\used it approximately 6378.1370 km.

    In spherical coordinates,  the polar and azimuth angles
can be used directly,  while in cylindrical coordinates,
